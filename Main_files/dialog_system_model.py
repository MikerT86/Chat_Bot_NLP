...
class System():
    ...
    def system_message(self):
        ...
        if self.current_state == "ASK_FOOD_TYPE":
            ...
            if pricerange != "" and area != "":
                message = "SYSTEM: There are {} restaurants in the {} price range and the {} part of town. What food type do you want? \n".format(rest_amount, pricerange, area)
            else:
                if pricerange != "":
                    message = "SYSTEM: There are {} restaurants in the {} price range. What food type do you want? \n".format(rest_amount, pricerange)
                else:
                    if area != "":
                        message = "SYSTEM: There are {} restaurants in the {} part of town. What food type do you want? \n".format(rest_amount, area)
                    else:
        ...
        if self.current_state == "ASK_PRICE_RANGE":
            ...
            if foodtype != "" and area != "":
                message = "SYSTEM: There are {} restaurants of {} food type in the {} part of town. What price range would you like? \n".format(rest_amount, foodtype, area)
            else:
                if foodtype != "":
                    message = "SYSTEM: There are {} restaurants of {} food type. What price range would you like? \n".format(rest_amount, foodtype)
                else:
                    if area != "":
                        message = "SYSTEM: There are {} restaurants in the {} part of town. What food type do you want? \n".format(rest_amount, area)
                    else:
        ...
        if self.current_state == "ASK_AREA":
            ...
            if foodtype != "" and pricerange != "":
                message = "SYSTEM: There are {} restaurants of {} food type and in the {} price range. What part of town do you have in mind? \n".format(rest_amount, foodtype, pricerange)
            else:
                if foodtype != "":
                    message = "SYSTEM: There are {} restaurants of {} food type. What part of town do you have in mind? \n".format(rest_amount, foodtype)
                else:
                    if pricerange != "":
                        message = "SYSTEM: There are {} restaurants in the {} price range. What part of town do you have in mind? \n".format(rest_amount, pricerange)
                    else:
    ...
    def extract_dialog_act(self, user_utterance):
        ...
        tokenized = tokenizer.tokenize(user_utterance)
